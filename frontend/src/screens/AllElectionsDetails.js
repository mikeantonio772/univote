...
export default function AllElectionsDetails({ navigation, route }) {
              ...
              <ScrollView>
                <Card>
                  <View alignItems='center'>
                    ...
                    {!data.is_active && <Text style={[styles.baseText, { marginBottom: 10 }]}>Eleição encerrada</Text>}
                    {!data.is_active && <Text style={[styles.baseText, { marginBottom: 20 }]}>Total de Votos: {data.__v}</Text>}
                  </View>
